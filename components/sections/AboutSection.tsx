      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 space-y-6 lg:-ml-10">
            ...
            {/* Main Headline */}
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tight text-white font-mono leading-[1.1]">
              WHERE IDEAS MEET <br />
            ...
            {/* Manifesto Box */}
            <div className="relative mt-8 p-6 border border-dashed border-zinc-800 bg-[#101114]">
              ...
              <p className="font-caveat text-lg sm:text-xl text-zinc-200 leading-snug pt-1">
          ...
          <div className="lg:col-span-7 flex justify-center items-center lg:translate-x-14">
            <div className="relative w-full max-w-[900px] aspect-square select-none rotate-[-1.5deg] drop-shadow-[0_25px_45px_rgba(0,0,0,0.85)] transition-transform duration-300">
              ...
              <div className="absolute inset-[6%] sm:inset-[8%] flex flex-col justify-between select-text pointer-events-auto text-zinc-300">
                ...
                <div className="grid grid-cols-12 gap-2 items-start pb-3 border-b border-zinc-700/50">
                  
                  {/* Left: Terminal Output */}
                  <div className="col-span-7 font-mono text-[10.5px] sm:text-xs leading-snug space-y-0.5">
                    <div className="text-zinc-400 uppercase tracking-widest text-[16px] mb-2 font-semibold pt-[19px]">
                      ZIGBEE.JU // ABOUT.EXE
                    </div>
                  ...
                  <div className="col-span-5 text-right font-caveat text-[20px] text-zinc-200 leading-tight pt-1 pr-1 select-none -rotate-2">
                    <p>same curiosity</p>
                    <p>more problems.</p>
                ...
                <div className="grid grid-cols-12 gap-3 py-3 border-b border-zinc-700/50 font-mono text-[10px] sm:text-xs">
                  ...
                  <div className="col-span-6 space-y-2">
                    ...
                    {TASKS.map((task) => (
                      ...
                      >
                        ...
                        <span
                          className={task.checked ? "text-zinc-200" : "text-zinc-400"}
                        >
                          {task.text}
                        </span>
                      </div>
                  ...
                  <div className="col-span-6 border-l border-zinc-700/50 pl-3 space-y-1">
                    <div className="text-zinc-400 font-bold uppercase tracking-wider text-[10px] mb-1.5">
                      CLUB STATS (ish)
                    </div>
                    ...
                    {CLUB_STATS.map((stat, idx) => (
                      <div key={idx} className="flex justify-between text-zinc-400">
                        ...
                        <span className="text-[11px] text-zinc-200 font-semibold">{stat.value}</span>
                      </div>
                    ))}
                  </div>
                ...
                <div className="pt-2 flex items-end justify-between font-caveat text-zinc-200 text-base sm:text-lg select-none">
                  <div>
                    <p>Unlike Others.</p>
                    <p className="flex items-center gap-1 flex-wrap">
                      ...
                      <span className="relative inline-block text-white">
                        are who
                        {/* Green marker stroke under 'students who' */}
                        <svg className="absolute -bottom-1 left-0 w-full h-2 text-[#22C55E]" viewBox="0 0 80 10" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                  ...
                  {/* Hand-drawn Smiley */}
                  <div className="text-xl sm:text-2xl text-zinc-300 select-none pb-0.5 pr-2">
                    :)
                  </div>
                </div>
